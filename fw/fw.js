...
var createClass = function(_classDesc) {
    ...
    work        = {_classDesc : null, _const : [], _proto : [], _added : {}, _implements : {}, _virtualMethods: {}, _errors : []};
    ...
    if (work._errors.length === 0) {
        ...
        try {
            ...
            eval(work._classDesc._fullName + " = function (_p) { _p = (_p ? _p : {});" + work._const.join("")+ "};" + work._proto.join("") +";");        
            return [];
        }
        catch(e) {
...
var createClass_addClass = function(_classDesc, _type, _work) {
	...
	if (_classDesc && _classDesc._name) {
		...
		createClass_addProperties(_classDesc, _type, _work);        
 ...
 * @param _work({}; mandatory) the object is generated by createClass @see (@function createClass)
 * */
var createClass_addProperties = function(_classDesc, _type, _work) {
                ...
                if (_classDesc[property]._type === "Method") {
                    ...
                    if (typeof(_classDesc[property]._method) === "function") {
                        if (_work._added[property] && !((_work._added[property]._overloadable && _classDesc[property]._overload) || property === "constructor")) {
                            ...
                            _work._proto.push(_work._classDesc._fullName + ".prototype." + (property === "constructor" ? _classDesc._constructorName  : property) + " = " + (_type === "creation" ? _work._classDesc._fullName + "" : _classDesc._fullName) +  ".prototype._._classDesc." + property + "._method;");
                ...
                if (typeof(_classDesc[property]._type) === "string") {
                    if (_classDesc[property]._type !== "Method") {
                        ...
                        if (_classDesc[property]._setter && !(_classDesc[setter] && _classDesc[setter]._type === "Method")) {
                            ...
                            eval("_classDesc[setter]._method = function(_object) {" + (_classDesc[property]._type === "*" ? root + property + " = _object; return true;" : "if (implements(\"" + _classDesc[property]._type + "\",_object)) {" + root + property + " = _object; return true;} return false;") + "};");
                        }
